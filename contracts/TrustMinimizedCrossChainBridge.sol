...
// Commit-reveal scheme disallows oracles to alter transactions, they can only attempt to censor transactions, but they won't do that with verifiable random number roles.
// Hash has to be generated by the user, keccak256 of user address, arguments for the next call, a string key(disposable pin or password of any length). all this separated by commas
