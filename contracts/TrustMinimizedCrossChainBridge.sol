...
// random number roles. Hash has to be generated by the user, keccak256 of user address, arguments for the next call, a string key(disposable pin or
// password of any length). all this separated by commas without spaces. 
// Hash has to correspond with keccak256(abi.encodePacked(address,arg1,arg2,arg3,arg4,disposableKey)). 
// Hash has to be posted by throwHash(), after oracles relay it to other chain, and after user confirms it's the hash he posted, he can then call cross()
// or callAcross() with the arguments and disposable key
